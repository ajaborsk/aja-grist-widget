  ...
  return (function e (t, n, r) {
  ...
  })(
    {
      1: [
        function (require, module, exports) {
          ...
          Entity.prototype.contentType = function (value) {
            ...
            if (!value && value !== null) {
              ...
              this._headers['Content-Type'] = parseHeaderValue(
                grammar.headerRules['Content-Type'],
                value
              )
              // Delete.
            } else {
          ...
          Entity.prototype.contentTransferEncoding = function (value) {
            ...
            if (!value && value !== null) {
              ...
              this._headers['Content-Transfer-Encoding'] = parseHeaderValue(
          ...
          function setBody (body) {
            ...
            if (Array.isArray(body)) {
              if (!contentType || contentType.type !== 'multipart') {
                ...
                this.contentType(
                  contentType.fulltype + ';boundary=' + randomString()
                )
              }
              // Single body.
            } else {
        ...
        { './grammar': 3, './parse': 5, debug: 6, 'random-string': 9 }
      ],
      2: [
        function (require, module, exports) {
          /**
        ...
        function (require, module, exports) {
          ...
          grammar.headerize = function (string) {
            ...
            for (part = 0; part < parts; part++) {
              ...
              hname +=
                name[part].charAt(0).toUpperCase() + name[part].substring(1)
            }
          ...
          function parseParams (rawParams) {
            ...
            for (i = 1, len = splittedParams.length; i < len; i++) {
              ...
              params[paramMatch[1].toLowerCase()] =
                paramMatch[3] || paramMatch[2]
            }
        ...
        function (require, module, exports) {
          ...
          function parseEntity (entity, rawEntity, topLevel) {
            ...
            if (headersEnd !== -1) {
              ...
              debugerror(
                'parseEntity() | wrong MIME headers in top level entity'
              )
              return false
            } else {
              if (/^\r\n/.test(rawEntity)) {
            ...
            if (contentType && contentType.type === 'multipart') {
              ...
              if (!boundary) {
                debugerror(
                  'parseEntity() | "multipart" Content-Type must have "boundary" parameter'
                )
                return false
              }
              ...
              while (true) {
                ...
                if (match) {
                  ...
                  if (partStart === undefined) {
                    debugerror(
                      'parseEntity() | no bodies found in a "multipart" sub-entity'
                    )
                    return false
                  }
                  ...
                  if (!match) {
                    debugerror(
                      'parseEntity() | no ending boundary in a "multipart" sub-entity'
                    )
                    return false
                  }
          ...
          function parseEntityHeaders (entity, rawHeaders) {
            ...
            for (i = 0, len = lines.length; i < len; i++) {
              ...
              if (!parseHeader(entity, line)) {
                debugerror(
                  'parseEntityHeaders() | invalid MIME header: "%s"',
                  line
                )
                return false
              }
